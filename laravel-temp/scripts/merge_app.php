<?php
 $src = dirname(__DIR__) . '/merge_staging/old_app';
 $dstRoot = dirname(__DIR__) . '/app';
 $conflicts = dirname(__DIR__, 2) . '/backup_old_generated_files/conflicts_app';
if (!is_dir($conflicts)) {
...
foreach ($it as $file) {
    ...
    if (!file_exists($dest)) {
        ...
        // do not overwrite; save source version next to dest for manual review
...
echo "App merge script completed.\n";
