    ...
    <header class="sticky top-0 z-40 bg-white/60 backdrop-blur-md shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <nav class="hidden md:flex items-center gap-6 text-sm font-medium">
                    <a href="{{ route('menu.index') }}" class="hover:text-gray-700">Menu</a>
                    <a href="{{ route('about') }}" class="hover:text-gray-700">About</a>
                    <a href="{{ route('gallery.index') }}" class="hover:text-gray-700">Gallery</a>
                    <a href="{{ route('events.index') }}" class="hover:text-gray-700">Events</a>
                    <a href="{{ route('blog.index') }}" class="hover:text-gray-700">Blog</a>
                    <a href="{{ route('contact.index') }}" class="hover:text-gray-700">Contact</a>
                </nav>
                <div class="flex items-center gap-3">
                    <a href="{{ route('reservation.index') }}" class="hidden md:inline-block px-4 py-2 rounded-md transition-smooth focus-ring" style="background:var(--brand-brown);color:var(--brand-cream)">Reserve</a>
        ...
        <div x-show="mobile" x-transition class="md:hidden bg-white border-t">
                ...
                <a href="{{ route('menu.index') }}" class="py-2">Menu</a>
                <a href="{{ route('about') }}" class="py-2">About</a>
                <a href="{{ route('gallery.index') }}" class="py-2">Gallery</a>
                <a href="{{ route('events.index') }}" class="py-2">Events</a>
                <a href="{{ route('blog.index') }}" class="py-2">Blog</a>
                <a href="{{ route('contact.index') }}" class="py-2">Contact</a>
                <a href="{{ route('reservation.index') }}" class="py-2 font-semibold" style="color:var(--brand-brown)">Reserve</a>
            </div>
        </div>
    </header>
